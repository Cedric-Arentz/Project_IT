...
public class Building {
    ...
    public static List<Building> setBuildingList()
    {
        ...
        buildings.add(new Building("Farm"   ,"Lorem ipsum blahblah"         ,"Sandbox/BasicGame/grandma.png",1100   , 8));
        buildings.add(new Building("Mine"   ,"Lorem ipsum blahblah"         ,"Sandbox/BasicGame/grandma.png",12000  , 47));
        buildings.add(new Building("Factory","Lorem ipsum blahblah"         ,"Sandbox/BasicGame/grandma.png",130000 , 260));
        return buildings;
    }
